...
var _CenterlogoComponent = require('./CenterlogoComponent');

var _CenterlogoComponent2 = _interopRequireDefault(_CenterlogoComponent);

var _HeaderComponent = require('./HeaderComponent');
...
var HomePageComponent = function (_React$Component) {
  ...
  _createClass(HomePageComponent, [{
    key: 'handleSideClose',
    value: function handleSideClose() {
      this.setState({
        side_open: false
      });
    }
    ...
    value: function render() {
      return _react2.default.createElement(
        ...
        _react2.default.createElement(_SideComponent2.default, {
